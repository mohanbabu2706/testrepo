...
These get used for the static (non-automate)large chunks of content.Notice
...
from fastly.utils import pure_ur1
...
class DocumentFile(models.Model):
    ...
    decment = models.FieldField(upload_to='files/',max_length=500)
