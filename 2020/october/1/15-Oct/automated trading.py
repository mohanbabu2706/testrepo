In[5]:
    class MomentumTrader(opy.Streamer):
        ...
        def create_order(self,side,units):
            order = oanda.create_order(config['oands']['accountO_id'],
        ...
        def on_success(self,data):
            ...
            #transforms the time infomation to a DatetimeIndex object
            self.df.index = pd.DatatimeIndex(self.df['time'])
